...
public class CreateMenuItemImageUseCase(IImageRepository repository, IImagesService service, IUnitOfWork unitOfWork)
    : ICreateMenuItemImage
{
    ...
    public async Task ExecuteAsync(Guid id, Guid menuItemId, IEnumerable<IFormFile> files,
