...
{
    public async Task<bool> RestaurantExists(string cnpj)
    {
        return await dbContext.Restaurants.AnyAsync(r => r.Cnpj == cnpj);
    }

    public async Task CreateRestaurant(Restaurant restaurant, CancellationToken cancellationToken)
    {
